...
| 3 | Aplicar Domain Events para propagar cambios del modelo          | Facilita desacoplamiento, integración y persistencia de eventos relevantes.             |
...
| 6 | Implementar Specifications para reglas de negocio reutilizables | Permite encapsular lógica compleja sin contaminar entidades o servicios.                |
